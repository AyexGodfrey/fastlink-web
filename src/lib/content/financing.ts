...
export const financingTopics: FinancingTopic[] = [
  {
    ...
    points: [
      ...
      "Works alongside Fast Link sourcing and logistics execution",
    ],
    pointsZh: [
      "与确认订单及运输计划挂钩的现金流支持",
      "便于银行或贸易伙伴审核的商业单证准备",
      "与生产、验货、货运对齐的付款与放款节点",
      "可与 Fast Link 寻源与物流执行协同推进",
    ],
  },
  {
