  ...
  return (
    <section className="relative min-h-[100svh] overflow-hidden text-white">
      <div
        ...
        style={{ backgroundImage: "url(/images/fastlink-trucks.jpg)" }}
      />
      {/* Strong left blend so copy stays readable; trucks remain visible on the right */}
      ...
      <div className="container-site relative flex min-h-[100svh] flex-col justify-end pb-20 pt-28 md:pb-28">
        <div className="max-w-xl md:max-w-2xl">
          ...
          >
            ...
            <Link href="/calculate" className="btn-secondary">
              {t("ctaCalculate")}
            </Link>
